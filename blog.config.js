...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个努力的干饭人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.gbsec.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备6666666', // 备案号 闽ICP备XXXXXXX
